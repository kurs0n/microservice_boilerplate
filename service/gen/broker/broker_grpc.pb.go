...
const (
	Greeter_SayHello2_FullMethodName = "/broker.Greeter/SayHello2"
)
...
func (c *greeterClient) SayHello2(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
func (UnimplementedGreeterServer) SayHello2(context.Context, *HelloRequest) (*HelloResponse, error) {
